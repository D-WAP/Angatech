...
<div class="presentation-content">
 <img src="logo.png" height="500" width="600">

  <div class="bottom-button-group">
    <a href="Examples/TalkKeyboard.php"><button class="retro-button red-button"><img src="talk2.png" height="250" width="250"><br>
	<font size="20dp">Talk Keyboard</button></a><a href="entertainment.php"><button class="retro-button yellow-button">	<img src="ent.png" height="250" width="250"><br>
	<font size="20dp">Entertainment
</button></a><a href="eyesite.php"><button class="retro-button blue-button"><img src="wheelchair.png" height="250" width="300"><br>
<font size="20dp">Wheelchair
</button></a><a href="helpcmd.php"><button class="retro-button green-button">	<img src="talk.png" height="250" width="250"><br>
	<font size="20dp">Help Commands
</button></a>
